package com.example.feedservice.aspect;
...
public class LoggingAspect {
    ...
    @Pointcut("within(com.example.feedservice.service..*) " +
              "|| within(com.example.feedservice.controller..*) " +
              "|| within(com.example.feedservice.client..*)")
