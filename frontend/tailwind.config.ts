...
export default {
  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        "brand-gradient": "linear-gradient(135deg, hsl(var(--brand-500)) 0%, hsl(280 80% 60%) 50%, hsl(330 85% 65%) 100%)",
      },
      borderRadius: {
        lg: "var(--radius)",
      ...
      keyframes: {
        ...
        "blob": { "0%,100%": { transform: "translate(0,0) scale(1)" }, "33%": { transform: "translate(40px,-30px) scale(1.1)" }, "66%": { transform: "translate(-30px,20px) scale(0.95)" } },
      },
      animation: {
